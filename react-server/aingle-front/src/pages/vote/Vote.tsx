...
const Vote = () => {
  ...
  return (
    <div className="bg-[#ffe8f1] min-h-screen w-full px-[16px] pb-[34px] flex flex-col items-center relative overflow-scroll">
      <PinkTextHeader />
      ...
      <ChDetailModal
        ...
        isPublic={isPublic}
      />
      <div className="w-full h-[30px] flex justify-center items-center"></div>
