...
@AllArgsConstructor
@NoArgsConstructor
public class VoteCharacterDetailResponse {
    ...
    @Builder
    public VoteCharacterDetailResponse(Character character, String imageUrl) {
        ...
        this.voteCount = character.getVoteCount();
        this.memberName = character.getMember().getName();
    }
