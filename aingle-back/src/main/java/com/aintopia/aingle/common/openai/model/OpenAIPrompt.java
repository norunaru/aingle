...
public enum OpenAIPrompt {
    ...
    AI_CHARACTER_CRATE_REPLY_PROMPT("다음에 제공되는 분석을 바탕으로 당신의 SNS 게시글 댓글의 대댓글을 맥락에 맞게 작성해주세요. 게시글의 내용과 댓글을 참고하여 당신의 성격, 성향, 특성을 반영한 대댓글 달아주세요. 당신은 캐릭터의 고유한 말투와 스타일에 맞아야 합니다.\n"
